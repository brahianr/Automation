package co.com.bancolombia.certification.screenplaytutorial.userinterfaces;
...
public class GoogleTranslatePage {
	...
	public static final Target TAERGET_LANGUAGE_OPTION = Target.the("Target language button").located(By.id("gt-tl-gms"));
	...
	public static final Target TARGET_LANGUAGE = Target.the("Target language").locatedBy("//*[@id='gt-tl-gms-menu']/table/tbody/tr/td//div[contains(text(), 'español')]");
